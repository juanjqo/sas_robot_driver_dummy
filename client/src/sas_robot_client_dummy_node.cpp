...
int main(int argc, char** argv)
{
    ...
    try
    {
        ...
        sas::RobotClientDummyConfiguration configuration;
        ...
        RCLCPP_INFO_STREAM_ONCE(node->get_logger(), "::Instantiating RobotClientDummyDriver.");
        auto robot_driver= std::make_shared<sas::RobotClientDummy>(node, configuration, &kill_this_process);
